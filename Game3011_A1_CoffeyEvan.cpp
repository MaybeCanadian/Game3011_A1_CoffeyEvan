...
void ShapesApp::BuildShapeGeometry()
{
	...
	for (size_t i = 0; i < grid.Vertices.size(); ++i, ++k)
	{
		...
		vertices[k].Color = XMFLOAT4(DirectX::Colors::PaleGreen);
	}
...
void ShapesApp::BuildRenderItems()
{
	...
	XMStoreFloat4x4(&boxRitem->World, XMMatrixScaling(1.0f, 1.0f, 1.0f) * XMMatrixTranslation(0.0f, 1.5f, 0.0f));
	...
	XMStoreFloat4x4(&wedgeRitem->World, XMMatrixScaling(1.0f, 1.0f, 1.0f) * XMMatrixTranslation(0.0f, 0.5f, -7.0f));
	...
	XMStoreFloat4x4(&coneRitem->World, XMMatrixScaling(1.0f, 1.0f, 1.0f) * XMMatrixTranslation(0.0f, 6.0f, 0.0f));
	...
	XMStoreFloat4x4(&pyramidRitem->World, XMMatrixScaling(1.0f, 1.0f, 1.0f) * XMMatrixTranslation(0.0f, 3.5f, 0.0f));
	...
	XMStoreFloat4x4(&diamondRitem->World, XMMatrixScaling(1.0f, 1.0f, 1.0f) * XMMatrixTranslation(0.0f, 9.0f, 0.0f));
	...
	XMStoreFloat4x4(&cylinder2Ritem->World, XMMatrixScaling(1.0f, 2.0f / 5.0f, 1.0f) * XMMatrixTranslation(0.0f, 5.0f, 0.0f));
	...
	for (int i = 0; i < 2; ++i) {
		...
		XMMATRIX circelWorld = XMMatrixTranslation(-2.5f + i * 5.0f, 0.5f, -6.0f);
	...
	for (int i = 0; i < 2; ++i)
	{
		...
		XMMATRIX leftCylWorld = XMMatrixTranslation(-5.0f, 2.5f, -5.0f + i * 10.0f);
		XMMATRIX rightCylWorld = XMMatrixTranslation(+5.0f, 2.5f, -5.0f + i * 10.0f);

		XMMATRIX leftPrismWorld = XMMatrixTranslation(-5.0f, 5.5f, -5.0f + i * 10.0f) * XMMatrixRotationY(XMConvertToRadians(90));
		XMMATRIX rightPrismWorld = XMMatrixTranslation(+5.0f, 5.5f, -5.0f + i * 10.0f) * XMMatrixRotationY(XMConvertToRadians(90));
